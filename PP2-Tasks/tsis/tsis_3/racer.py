...
def play_game(screen, username):
    ...
    image_background = pygame.image.load('PP2-Tasks/tsis/tsis_3/assets/AnimatedStreet.png')
    image_player     = pygame.image.load('PP2-Tasks/tsis/tsis_3/assets/Player.png')
    image_enemy      = pygame.image.load('PP2-Tasks/tsis/tsis_3/assets/Enemy.png')
    coin_image       = pygame.image.load('PP2-Tasks/tsis/tsis_3/assets/dollar.png').convert_alpha()

    if settings.get("sound", True):
        pygame.mixer.music.load('PP2-Tasks/tsis/tsis_3/assets/background.wav')
        pygame.mixer.music.play(-1)
    else:
        pygame.mixer.music.stop()
    sound_crash = pygame.mixer.Sound('PP2-Tasks/tsis/tsis_3/assets/crash.wav')
